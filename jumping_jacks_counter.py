...
from utils.pose_utils import count_repetitions_jumping_jacks
import requests
...
while cap.isOpened():
    ...
    frame, counter, stage = count_repetitions_jumping_jacks(frame, counter, stage)

    send_reps_to_backend("jumping_jacks", counter)
