...
from utils.pose_utils import count_repetitions_squats
import requests
...
while cap.isOpened():
    ...
    frame, counter, stage = count_repetitions_squats(frame, counter, stage)

    send_reps_to_backend("squats", counter)
